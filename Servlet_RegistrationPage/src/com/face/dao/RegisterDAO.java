...
public class RegisterDAO {
	...
	public static void save(Connection c,RegisterBO regbo) {
		try {
	        ...
	        String string="INSERT INTO register(firstName,lastName,userName,password,emailId,mobno) VALUES ('"+regbo.getFname()+"','"+regbo.getLname()+"','"+regbo.getUname()+"','"+regbo.getPswd()+"','"+regbo.getEmailId()+"','"+regbo.getMobile()+"')";
